 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more poliss than the sum of the input amounts
 * @return {string}
 */
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://poliscore.io/api/lib/transaction#serialization-checks';
 ...
 *
 * Can receive, as output information, the output of polisd's `listunspent` command,
 * and a slightly fancier format recognized by poliscore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a poliscore Address object. The
 * same is true for `script`, which can be a string or a poliscore Script.
 *
 ...
 *
 * // From a pay to public key hash output from polisd's listunspent
 ...
 *
 * @see {https://github.com/polis/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
 ...
 * CheckTransaction in polis core.
 */
...
/**
 * Analogous to polisd's IsCoinBase function in transaction.h
 */

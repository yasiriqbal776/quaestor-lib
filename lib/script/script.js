...
/**
 * A polis transaction script. Each transaction's inputs and outputs
 * has a script that is evaluated to validate it's spending.
 *
 * See https://en.polis.it/wiki/Script
 *
 * @constructor
...
/**
 * Analogous to polisd's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from polisd's script interpreter CheckMinimalPush function
...
/**
 * Comes from polisd's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from polisd's script GetSigOpCount(boolean) function

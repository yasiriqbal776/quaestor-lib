...
var HDPrivateKey = poliscore.HDPrivateKey;
var HDPublicKey = poliscore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  it('should use full 32 bytes for private key data that is hashed (as per bip32)', function() {
    // https://github.com/polis/bips/blob/master/bip-0032.mediawiki
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = poliscore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(poliscore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(poliscore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      poliscore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = poliscore.PublicKey.fromPoint;
      poliscore.PublicKey.fromPoint = function() {
        poliscore.PublicKey.fromPoint = unstubbed;
...
//test vectors: https://github.com/polis/bips/blob/master/bip-0032.mediawiki

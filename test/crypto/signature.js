...
var JSUtil = poliscore.util.js;
var Interpreter = poliscore.Script.Interpreter;

var sig_canonical = require('../data/polisd/sig_canonical');
var sig_noncanonical = require('../data/polisd/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('polisd fixtures', function() {

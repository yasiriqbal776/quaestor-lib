# Public Key
Represents a polis public key and is needed to be able to receive polis, as is usually represented as a polis [Address](address.md). See the official [Polis Wiki](https://en.polis.it/wiki/Technical_background_of_version_1_Polis_addresses).

A PublicKey in Poliscore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
A public key point should be on the [secp256k1](https://en.polis.it/wiki/Secp256k1) curve, instantiating a new PublicKey will validate this and will throw an error if it's invalid. To check that a public key is valid:
...
> var compressedPK = poliscore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new poliscore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = poliscore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+

...
For detailed technical information about a block please visit [Blocks](https://en.polis.it/wiki/Blocks#Block_structure) on the Polis Wiki.
...
For more information about the specific properties of a block header please visit the [Block hashing algorithm](https://en.polis.it/wiki/Block_hashing_algorithm) page on the Polis Wiki.

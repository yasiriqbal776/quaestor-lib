...
We're working hard to make *poliscore* the most powerful JavaScript library for working with polis. Our goal is to have *poliscore* be a library that can be used by anyone interested in polis, and to level expertise differences with great design and documentation.
